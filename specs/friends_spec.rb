...
#   result = get_favourite_food(@person1)
#   assert_equal("charcuterie",result)
# end
#
# def test_favourite_food
#   result = get_favourite_food(@person2)
#   assert_equal("bread",result)
# end
#
# def test_favourite_food
#   result = get_favourite_food(@person3)
...
def test_total_amount_of_money
result = total_amount_of_money(@people)
